...
const UserEnquiryForm = () => {
  ...
  return (
    <div className="container shadow-sm my-5 p-4 rounded" style={{ maxWidth: '600px', backgroundColor: '#f8f9fa', borderLeft: '5px solid #0d6efd' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3 d-flex align-items-center">
          ...
          <button type="button" className={`btn btn-${otpVerified ? 'success' : 'primary'}`} onClick={sendOtp} disabled={otpSent && !otpVerified} style={{ height: 'fit-content', marginTop: '1.9rem' }}>
